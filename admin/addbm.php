...
<body>
  ...
  <section class="home-section">
    ...
    <!-- ================ Add Product Details================= -->
    <div class="container">
      <center><h1>Add Product Details</h1></center>
      <form action="bmprocess.php" method="POST" enctype="multipart/form-data">

        <div class="row">
          <div class="col-25">
            <label for="Category">Full Namw</label>
          </div>
          <div class="col-75">
            <input type="text" name="bname" placeholder="Full Name" required>
          </div>
        </div>
        ...
        <div class="row">
          ...
          <div class="col-75">
          <input type="text" name="bdsg" placeholder="Designation" required>
          </div>
        </div>
        <div class="row">
          <div class="col-25">
          ...
          <div class="col-75">
          <input type="text" name="badd" placeholder="Address" required>
          </div>
        </div>
        <div class="row">
          <div class="col-25">
          ...
          <div class="col-75">
          <input type="text" name="bmn" placeholder="Mobile No" required>
          </div>
        </div>
        ...
        <div class="row">
          <input type="submit" value="Add Board Members" name="submit">
        </div>
      </form>
    </div>
