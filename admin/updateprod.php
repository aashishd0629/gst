    ...
    <div class="container">
      ...
      <form action="upp.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-75">
            <select id="pts" name="ptyp">
              ...
              $id= $_GET['id'];
              include 'dbconn.php';
              $query = mysqli_query($conn, "SELECT * FROM productlist where id=$id");
        ...
        <div class="row">
          ...
          <div class="col-75">
            <textarea id="pdesc" name="pdesc" style="height:200px" required><?php echo $row['prod_desc']; ?></textarea>
          </div>
        </div>
        <div class="row">
          <div class="col-25">
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input type="text" id="wgt" name="pwgt" value="<?php echo $row['pr_weight']; ?>">
          </div>
        </div>
        <div class="row">
          <div class="col-25">
            <label for="prate">Rate</label>
          </div>
          <div class="col-75">
            <input type="text" id="prate" name="prate" value="<?php echo $row['pr_rate']; ?>">
          </div>
        </div>
        <br>
        <?php } ?>
        <input type="hidden" id="pid" name="prid" value="<?php echo $id; ?>">
