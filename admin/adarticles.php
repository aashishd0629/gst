...
<body>
    ...
    <section class="home-section">
        ...
        <!-- ================ Add Category ================= -->
        <div class="container">
          <center><h1>Add Atricles</h1></center>
        <div class="container">
      <form action="articleprocess.php" method="POST" onsubmit="return validateform()" enctype="multipart/form-data" name="adar">
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-75">
              <textarea id="pdesc" name="adesc" placeholder="Description" style="height:200px" required></textarea>
            </div>
          </div>
          <div class="row">
            <div class="col-25">
