...
<body>
    ...
    <section class="home-section">
      ...
      <form action="sbcatprocess.php" method="POST" enctype="multipart/form-data">
        <div class="row">
          <div class="row">
            <div class="col-25">
          ...
          <div class="row">
            ...
            <div class="col-75">
              <input type="text" id="catg" name="scatg" placeholder="categoty" required>
            </div>
          </div>
          <div class="row">
