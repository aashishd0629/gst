        ...
        <div class="details">
                <div class="recentOrders">
                    ...
                    <table>
                        ...
                        <?php
                include 'dbconn.php';
                $query = mysqli_query($conn, "SELECT * FROM oderd" );
                ...
                ?>
                            <tr>
                                ...
                                <td>
                        <a href="updateorder.php?id=<?php echo $row['id'] ?>" ><i class='bx bxs-edit bx-lg' style="font-size:30px; color:blue;"></i></a>
                        <a href="deleteorder.php?id=<?php echo $row['id'] ?>" onclick="return checkDelete()" ><i class='bx bxs-message-square-x' style="font-size:30px; color:red;"></i></a>
                        </td>
