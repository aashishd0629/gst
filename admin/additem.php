...
<body>
  ...
  <section class="home-section">
    ...
    <div class="container">
      ...
      <form action="itemprocess.php" method="POST" enctype="multipart/form-data">
        ...
        <div class="row">
          ...
          <div class="col-75">
            <textarea id="pdesc" name="pdesc" placeholder="Description" style="height:200px" required></textarea>
          </div>
        </div>
        <div class="row">
          <div class="col-25">
        ...
        <div class="row">
          ...
          <div class="col-75">
            <input type="text" id="wgt" name="pwgt">
          </div>
        </div>
        <div class="row">
          <div class="col-25">
