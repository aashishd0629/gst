...
<body>
    ...
    <section class="home-section">
        ...
        <div class="container">
      <form action="eventprocess.php" method="POST" onsubmit="return validateform()" enctype="multipart/form-data" name="adar">
        <div class="row">
          ...
          <div class="row">
            ...
            <div class="col-75">
              <textarea id="pdesc" name="edesc" placeholder="Description" style="height:200px" required></textarea>
            </div>
          </div>
          <div class="row">
            <div class="col-25">
