...
<body>
    ...
    <section class="home-section">
        ...
        <!-- ================ Add  Sub-Category ================= -->
        <div class="container">
        <center><h1>Add Type</h1></center>
      <form action="typeprocess.php" method="POST" enctype="multipart/form-data">
        <div class="row">
          <div class="row">
            <div class="col-25">
          ...
          <div class="row">
            ...
            <div class="col-75">
              <input type="text" id="catg" name="tpe" placeholder="type" required>
            </div>
          </div>
          <div class="row">
