		...
		<div class="login-form">
			...
			<div class="sign-in-htm">
				<div class="group">
					...
					<input id="user" type="text" class="input" name="uemail">
				</div>
				<div class="group">
			...
			<div class="sign-up-htm">
                ...
                <div class="group">
					...
					<input id="user" type="text" class="input" name="radd">
				</div>
                <div class="group">
					<label for="phone" class="label">Phone no</label>
					<input id="user" type="text" class="input" name="rno">
				</div>
				<div class="group">
					<label for="pass" class="label">Password</label>
					<input id="pass" type="password" class="input" data-type="password" name="fpass">
				</div>
				
				<div class="group">
					<label for="pass" class="label">Email Address</label>
					<input id="pass" type="text" class="input" name="femail">
				</div>
				<div class="group">
